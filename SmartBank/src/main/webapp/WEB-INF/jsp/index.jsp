...
<br/>
<p style="font-style:italic;">NOTE: To access your account, you will need your ATM card and your ATM PIN.&nbsp;</p>

<br/>

<p><input style="width:120px" type="submit" value="BEGIN &gt;&gt;" onclick="window.location='/SmartBank/login'" /></p>
